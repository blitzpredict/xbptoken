...
contract VestingManager is BaseContract, Owned, TokenRetriever {
    ...
    function VestingManager(IToken _token)
        public
    {
    ...
    {
        // Check that we have enough token balance to manage this grant.
        totalVesting = totalVesting.add(_value);
        require(totalVesting <= token.balanceOf(address(this)));
